...
LOCAL_PACKAGE_NAME := FreemeCamera2
LOCAL_OVERRIDES_PACKAGES := Camera2 DreamCamera2
...
LOCAL_REQUIRED_MODULES := libjni_mosaic_dream libself_portrait_jni libjni_mosaic_new libSprdImageFilterResource freemeCamConfig.xml
...
include $(CLEAR_VARS)
LOCAL_MODULE := freemeCamConfig.xml
