...
public class EffectProgressBar extends View {
    ...
    public static final int DEFAULT_LINE_HEIGHT = 4;
    ...
    public EffectProgressBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public EffectProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnProgressChangedListener {
        void onProgressChanged(EffectProgressBar progressBar, float progress, boolean isNeedStorage);
    }
}
