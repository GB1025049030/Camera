...
public class AutoCenterHorizontalScrollView extends HorizontalScrollView implements
    ...
    private void init() {
        ...
        mPaddingLeft = first_width/2;
        mPaddingRight = getScreenWidth(getContext()) - last_width;//SPRD:fix bug1251753
    ...
    public void setIndexWithoutDatachange(int currentIndex) {
        if (mAdapter != null && mAdapter.getCount() > 0 && currentIndex < mAdapter.getCount()) {
            mAdapter.onSelectStateChanged(mViewHolders.get(mHVSCurrentIndex), mHVSCurrentIndex, false);
            this.mHVSCurrentIndex = currentIndex;
            mAdapter.onSelectStateChanged(mViewHolders.get(currentIndex), currentIndex, true);
        }
        updateViewPosition(currentIndex);
    }
    ...
    private void updateViewPosition(int currentIndex) {
        if (getChildCount() <= 0) {
            return;
        }
        ViewGroup viewGroup = (ViewGroup) getChildAt(0);
    ...
    public com.dream.camera.ui.AutoCenterHorizontalScrollView.OnSelectChangeListener onSelectChangeListener;

    public void setOnSelectChangeListener(com.dream.camera.ui.AutoCenterHorizontalScrollView.OnSelectChangeListener onSelectChangeListener) {
