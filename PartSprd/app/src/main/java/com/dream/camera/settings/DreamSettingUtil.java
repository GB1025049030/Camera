...
import com.freeme.camera.settings.FreemeDataConfig;
    ...
    private static int getSupportDataFrontVideo(int mode , int id) {
        ...
        switch (mode) {
            ...
            case DataConfig.VideoModeType.VIDEO_MODE_FRONT_INTENT_CAPTURE:
                resourceID = R.array.video_front_mode_auto_setting;
                break;
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_FRONT_EFFECT_VIDEO:
                resourceID = R.array.effect_video_front_mode_auto_setting;
                break;
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_FRONT_SLOW_VIDEO:
                resourceID = R.array.slow_video_front_mode_auto_setting;
                break;
            default:
                break;
        }
    ...
    private static int getSupportDataBackVideo(int mode , int id) {
        ...
        switch (mode) {
            ...
            case DataConfig.VideoModeType.VIDEO_MODE_BACK_MACRO:
                ...
                break;
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_BACK_EFFECT_VIDEO:
                resourceID = R.array.effect_video_back_mode_auto_setting;
                break;
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_BACK_SLOW_VIDEO:
                resourceID = R.array.slow_video_back_mode_auto_setting;
                break;
            default:
                break;
        }
    ...
    private static int getSupportDataFrontPhoto(int mode , int id) {
        ...
        switch (mode) {
            ...
            case DataConfig.PhotoModeType.PHOTO_MODE_FRONT_HIGH_RESOLUTION:
                ...
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_FRONT_DEPTH_BLUR:
                resourceID = R.array.photo_front_depth_blur_setting;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_FRONT_EFFECT:
                resourceID = R.array.photo_front_effect_setting;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_FRONT_NIGHT:
                resourceID = R.array.photo_front_night_setting;
                break;
            default:
                break;
        }
    ...
    private static int getSupportDataBackPhoto(int mode , int id) {
        ...
        switch (mode) {
            ...
            case DataConfig.PhotoModeType.PHOTO_MODE_BACK_MACRO:
                ...
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_SLR:
                resourceID = R.array.photo_back_slr_setting;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_DEPTH_BLUR:
                resourceID = R.array.photo_back_depth_blur_setting;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_IKO:
                resourceID = R.array.photo_back_iko_setting;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_EFFECT:
                resourceID = R.array.photo_back_effect_setting;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_NIGHT:
                resourceID = R.array.photo_back_night_setting;
                break;
            default:
                break;
        }
    ...
    private static int getPrefUIFrontPhoto(int mode , int id) {
        ...
        switch (mode) {
            ...
            case DataConfig.PhotoModeType.PHOTO_MODE_FRONT_HIGH_RESOLUTION:
                ...
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_FRONT_DEPTH_BLUR:
                resourceID = R.array.photo_front_mode_depth_blur_setting_display;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_FRONT_EFFECT:
                resourceID = R.array.photo_front_mode_effect_setting_display;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_FRONT_NIGHT:
                resourceID = R.array.photo_front_mode_night_setting_display;
                break;
            default:
                break;
        }
    ...
    private static int getPrefUIBackPhoto(int mode , int id) {
        ...
        switch (mode) {
            ...
            case DataConfig.PhotoModeType.PHOTO_MODE_BACK_MACRO:
                ...
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_SLR:
                resourceID = R.array.photo_back_mode_slr_setting_display;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_IKO:
                resourceID = R.array.photo_back_mode_iko_setting_display;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_DEPTH_BLUR:
                resourceID = R.array.photo_back_mode_depth_blur_setting_display;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_EFFECT:
                resourceID = R.array.photo_back_mode_effect_setting_display;
                break;
            case FreemeDataConfig.PhotoModeType.PHOTO_MODE_BACK_NIGHT:
                resourceID = R.array.photo_back_mode_night_setting_display;
                break;
            default:
                break;
        }
    ...
    private static int getPrefUIFrontVideo(int mode , int id) {
        ...
        switch (mode) {
            ...
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_FRONT_EFFECT_VIDEO:
                ...
                break;
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_FRONT_SLOW_VIDEO:
                resourceID = R.array.slow_video_front_mode_auto_setting_display;
                break;
            default:
                break;
        }
    ...
    private static int getPrefUIBackVideo(int mode , int id) {
        ...
        switch (mode) {
            ...
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_BACK_EFFECT_VIDEO:
                ...
                break;
            case FreemeDataConfig.VideoModeType.VIDEO_MODE_BACK_SLOW_VIDEO:
                resourceID = R.array.slow_video_back_mode_auto_setting_display;
                break;
            default:
                break;
        }
