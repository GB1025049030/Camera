...
public class DataModulePhoto extends DataModuleInterfacePV {
    ...
    private void setMutexColorEffect(String key, String entryValue,
        ...
        if (!mContext.getString(
            ...
            // COLOR EFFECT - AI_BEAUTY
            if (getBoolean(Keys.KEY_CAMERA_AI_BEAUTY_ENTERED)) {
                continueSetMutex(Keys.KEY_CAMERA_AI_BEAUTY_ENTERED, false, keyList,
                        "color mutex with Ai Beauty");
            }
        }
        // RESTORE
        else {
            ...
            continueSetRestore(Keys.KEY_CAMERA_BEAUTY_ENTERED, keyList,
                    "color restore beauty");
            continueSetRestore(Keys.KEY_CAMERA_AI_BEAUTY_ENTERED, keyList,
                    "color restore ai_beauty");
        }
    }
