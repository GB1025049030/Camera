...
public class IntervalPhotoUI extends PhotoUI implements
    ...
    private View beautyButtonPanel;
    ...
    protected int getTopPanelConfigID() {
        return R.array.interval_photo_top_panel;
    }

    @Override
    protected int getSidePanelConfigID() {
        return R.array.interval_photo_side_panel;
    }
    ...
    public void fitExtendPanel(ViewGroup extendPanelParent) {
        ...
        if (mBasicModule.isBeautyCanBeUsed()) {
            lf.inflate(R.layout.sprd_intervalphoto_extend_panel, extendPanelParent);
            mMakeupController = new MakeupController(extendPanelParent,
                    mController,mActivity);
        } else {
            lf.inflate(R.layout.interval_photo_extend_panel, extendPanelParent);
        }
        ...
        mActivity.getCameraAppUI().updateExtendLayoutParams(extendPanelParent, SettingsScopeNamespaces.INTERVAL);
    }
