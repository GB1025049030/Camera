...
final class CameraConfigurationManager {
    ...
    public void findBestWidthAndHeight(CameraSettings mCameraSettings, Point screenResolution,
        ...
        int screenResolutionX = screenResolutionY * 16 / 9;
        ...
        for (int i = 0; i < previewSizes.size(); i++) {
            ...
            int newDiffs = Math.abs(mCameraPreviewWidth - screenResolutionX) + Math.abs(mCameraPreviewHeight - screenResolutionY);
            if(newDiffs == 0){
