...
public class DreamUISettingPartCamera extends DreamUISettingPartBasic implements DreamSettingResourceChangeListener, OnPreferenceChangeListener{
    ...
    private void updateVisibilityGradienter() {
        if (!FreemeCameraUtil.isGradienterEnable()) {
            recursiveDelete(this, findPreference(FreemeKeys.KEY_CAMERA_SHOW_GRADIENTER));
        }
    }
}
