...
public class DataModuleVideo extends DataModuleInterfacePV {
    ...
    public void initializeStaticParams(CameraProxy proxy) {
        ...
        if (loader != null) {
            ...
            if (isFourKSelected() && getString(Keys.KEY_VIDEO_QUALITY_BACK).equals("large")
                    && (isEnableSettingConfig(Keys.KEY_EOIS_DV_BACK) && getBoolean(Keys.KEY_EOIS_DV_BACK))){
                changeAndNotify(Keys.KEY_VIDEO_QUALITY_BACK,getString(Keys.KEY_VIDEO_QUALITY_BACK));
            }
