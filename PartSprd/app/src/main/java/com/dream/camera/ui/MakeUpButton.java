...
public class MakeUpButton extends LinearLayout {
    ...
    private void setSkinSmoothSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_skin_grinding_pressed
                : R.drawable.effect_skin_grinding_normal);
    ...
    private void setRemoveBlemishSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_remove_blemish_pressed
                : R.drawable.effect_remove_blemish_normal);
        mBtShow.setTextColor(selected ? mContext.getResources()
                .getColor(R.color.dream_yellow) : Color.WHITE);
    }

    private void setSkinBrightSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_skin_whitening_pressed
                : R.drawable.effect_skin_whitening_normal);
        mBtShow.setTextColor(selected ? mContext.getResources()
                .getColor(R.color.dream_yellow) : Color.WHITE);
    }

    private void setSkinColorSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_skin_color_pressed
                : R.drawable.effect_skin_color_normal);
        mBtShow.setTextColor(selected ? mContext.getResources()
                .getColor(R.color.dream_yellow) : Color.WHITE);
    }
    ...
    private void setLargeEyesSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_big_eye_pressed
                : R.drawable.effect_big_eye_normal);
        mBtShow.setTextColor(selected ? mContext.getResources()
                .getColor(R.color.dream_yellow) : Color.WHITE);
    }

    private void setSlimFaceSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_face_lift_pressed
                : R.drawable.effect_face_lift_normal);
        mBtShow.setTextColor(selected ? mContext.getResources()
                .getColor(R.color.dream_yellow) : Color.WHITE);
    }

    private void setLipsColorSelected(boolean selected) {
        mBt.setImageResource(selected ? R.drawable.effect_lip_color_pressed
                : R.drawable.effect_lip_color_normal);
        mBtShow.setTextColor(selected ? mContext.getResources()
                .getColor(R.color.dream_yellow) : Color.WHITE);
    }
