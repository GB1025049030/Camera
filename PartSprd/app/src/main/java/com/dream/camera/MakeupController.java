...
import com.freeme.camera.widget.selector.MakeUpControllerImpl;
import com.freeme.camera.widget.selector.SelectorContainer;
import com.freeme.camera.widget.selector.SelectorController;
import com.freeme.camera.widget.selector.SelectorScroller;
import com.freeme.camera.widget.selector.SelectorSwitcher;
import com.freeme.camera.widget.selector.interfaces.InterfaceSelectorController;
import com.freeme.camera.widget.selector.interfaces.InterfaceSelectorItem;
...
public class MakeupController implements View.OnClickListener, MakeUpLevel.MakeupLevelListener, InterfaceSelectorController.CallBack, SelectorController.InitializeCallBack {
    ...
    private final String F_SkIN_SMOOTH_DV = CameraCustomManager.I.getSkinSmoothDefaultValueFront("6");
    private final String F_SkIN_BRIGTH_DV = CameraCustomManager.I.getSkinBrightDefaultValueFront("6");
    private final String F_SLIM_FACE_DV = CameraCustomManager.I.getSlimFaceDefaultValueFront("2");
    private final String F_ENLARGE_EYES_DV = CameraCustomManager.I.getEnlargeEyesDefaultValueFront("2");
    private final String F_SKIN_COLOR_DV = CameraCustomManager.I.getSkinColorDefaultValueFront("0");
    private final String F_SKIN_TYPE_DV = CameraCustomManager.I.getSkinColorDefaultTypeFront("0");
    private final String F_LIPS_COLOR_DV = CameraCustomManager.I.getLipsColorDefaultValueFront("4");
    private final String F_LIPS_TYPE_DV = CameraCustomManager.I.getLipsColorDefaultTypeFront("0");
    private final String F_REMOVE_BLEMISH_DV = CameraCustomManager.I.getRemoveBlemishDefaultValueFront("1");

    // back camera default values
    private final String B_SkIN_SMOOTH_DV = CameraCustomManager.I.getSkinSmoothDefaultValueBack("6");
    private final String B_SkIN_BRIGHT_DV = CameraCustomManager.I.getSkinBrightDefaultValueBack("6");
    private final String B_SLIM_FACE_DV = CameraCustomManager.I.getSlimFaceDefaultValueBack("2");
    private final String B_ENLARGE_EYES_DV = CameraCustomManager.I.getEnlargeEyesDefaultValueBack("2");
    private final String B_SKIN_COLOR_DV = CameraCustomManager.I.getSkinColorDefaultValueBack("0");
    private final String B_SKIN_TYPE_DV = CameraCustomManager.I.getSkinColorDefaultTypeBack("0");
    private final String B_LIPS_COLOR_DV = CameraCustomManager.I.getLipsColorDefaultValueBack("4");
    private final String B_LIPS_TYPE_DV = CameraCustomManager.I.getLipsColorDefaultTypeBack("0");
    private final String B_REMOVE_BLEMISH_DV = CameraCustomManager.I.getRemoveBlemishDefaultValueBack("1");

    private String mSkinSmoothDefaultValue = B_SkIN_SMOOTH_DV;
    /**this is for arc beatuy lib **/
    private String mSkinBrightDefaultValue = B_SkIN_BRIGHT_DV;

    /**0:white, 1:rosy, 2:wheat, this is for sprd beatuy lib**/
    private String mSkinColorDefaultType = B_SKIN_TYPE_DV;
    private String mSkinColorDefaultLevel = B_SKIN_COLOR_DV;

    private String mEnlargeEyesDefaultValue = B_SLIM_FACE_DV;
    private String mSlimFaceDefaultValue = B_ENLARGE_EYES_DV;
    private String mRemoveBlemishDefaultValue = B_REMOVE_BLEMISH_DV;

    /**0:crimson, 1:pink, 2:fuchsia, this is for sprd beatuy lib**/
    private String mLipsColorDefaultType = B_LIPS_TYPE_DV;
    private String mLipsColorDefaultLevel = B_LIPS_COLOR_DV;

    private String mLipsColorDefaultLevelForAI = "0";

    protected final CameraActivity mActivity;
    MakeUpControllerImpl mMakeUpController;
    SelectorScroller mMakeUpScroller;
    SelectorSwitcher mMakeUpSwitcher;
    ...
    public MakeupController(View extendPanelParent, MakeupListener listener, CameraActivity activity) {
        ...
        if (extendPanelParent != null) {
            ...
            SelectorContainer makeUpContainer = (SelectorContainer)extendPanelParent.findViewById(R.id.make_up_container);
            ...
            mMakeUpController = new MakeUpControllerImpl(mActivity,
                    mMakeUpScroller,makeUpContainer,mMakeUpSwitcher,this, this);
    ...
    public void resume(boolean enable){
        if (enable && mMakeUpController != null && mMakeUpController.getSize() > 0) {
            Log.i(TAG, "resume Makeup Controller View");
            resetAllIcon();
            int index = mMakeUpController.getSelectedIndex();
            index = index == -1 ? 0 : index;

            mMakeUpController.enableFeatureOperation(true);
    ...
    private void initMakeupLevel() {
        ...
        if(mCurrentDataModule.getDataSetting().mIsFront){
            ...
            mRemoveBlemishDefaultValue = F_REMOVE_BLEMISH_DV;
            mSkinColorDefaultLevel = F_SKIN_COLOR_DV;
            mSkinColorDefaultType = F_SKIN_TYPE_DV;
            mLipsColorDefaultLevel = F_LIPS_COLOR_DV;
            mLipsColorDefaultType = F_LIPS_TYPE_DV;
        } else {
            mSkinSmoothDefaultValue = B_SkIN_SMOOTH_DV;
            mSkinBrightDefaultValue = B_SkIN_BRIGHT_DV;
            mSlimFaceDefaultValue = B_SLIM_FACE_DV;
            mEnlargeEyesDefaultValue = B_ENLARGE_EYES_DV;
            mRemoveBlemishDefaultValue = B_REMOVE_BLEMISH_DV;
            mSkinColorDefaultLevel = B_SKIN_COLOR_DV;
            mSkinColorDefaultType = B_SKIN_TYPE_DV;
            mLipsColorDefaultLevel = B_LIPS_COLOR_DV;
            mLipsColorDefaultType = B_LIPS_TYPE_DV;
        }
        if (mSkinSmoothPanel != null) {
