...
import com.dream.camera.effect.glutils.RenderHandler;
...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    public MediaVideoEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener, final int width, final int height) {
        ...
        mRenderHandler.setPreviewSize(width, height);
    }
    ...
    public void setEglContext(final EGLContext shared_context, final int tex_id, EffectRenderHelper effectRenderHelper) {
        mEffectRenderHelper = effectRenderHelper;
        mRenderHandler.setEglContext(shared_context, tex_id, mSurface, true, effectRenderHelper);
    }
