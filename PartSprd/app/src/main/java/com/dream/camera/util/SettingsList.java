...
public class SettingsList {
    ...
    public final static int[] FOCUSDISTANCE_DISPLAY_ICON = {
        R.drawable.ic_freeme_operate_focus_auto_selected,
        R.drawable.ic_freeme_operate_focus_auto_unselected,
        R.drawable.ic_freeme_operate_focus_micro_selected,
        R.drawable.ic_freeme_operate_focus_micro_unselected,
        R.drawable.ic_freeme_operate_focus_manual_selected,
        R.drawable.ic_freeme_operate_focus_manual_unselected,
        R.drawable.ic_freeme_operate_focus_infinity_selected,
        R.drawable.ic_freeme_operate_focus_infinity_unselected
    };
