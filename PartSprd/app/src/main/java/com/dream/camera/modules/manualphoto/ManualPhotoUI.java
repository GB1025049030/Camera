...
public class ManualPhotoUI extends PhotoUI implements
    ...
    protected int getTopPanelConfigID() {
        return R.array.manual_photo_top_panel;
    }
    ...
    private void changeIconUI(View view, int visible) {
        ...
        changeOneIconUI(eExposureBtn , eExposureIcon , view , eExposureTv , visible , showOrHide ,
                R.drawable.ic_freeme_operate_ev_sprd_selected,
                R.drawable.ic_freeme_operate_ev_sprd_unselected);

        changeOneIconUI(eExposureTimeBtn , eExposureTimeIcon , view , eExposureTimeTv , visible , showOrHide ,
                R.drawable.ic_freeme_operate_shutter_selected,
                R.drawable.ic_freeme_operate_shutter_unselected);
        ...
        changeOneIconUI(eIsoBtn , eIsoIcon , view , eIsoTv , visible , showOrHide ,
                R.drawable.ic_freeme_operate_iso_sprd_selected,
                R.drawable.ic_freeme_operate_iso_sprd_unselected);

        changeOneIconUI(eWbBtn , eWbIcon , view , eWbTv , visible , showOrHide ,
                R.drawable.ic_freeme_operate_wb_auto_sprd_selected,
                R.drawable.ic_freeme_operate_wb_auto_sprd_unselected);

        changeOneIconUI(eStyleBtn , eStyleIcon , view , eStyleTv , visible , showOrHide ,
                R.drawable.ic_freeme_operate_art_style_sprd_selected,
                R.drawable.ic_freeme_operate_art_style_sprd_unselected);
    }
