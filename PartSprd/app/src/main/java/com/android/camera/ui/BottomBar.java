...
public class BottomBar extends FrameLayout {
    ...
    private TextView mCenterScanText;
...
//        setupShutterBackgroundForModeIndex(index);
    ...
    public void setShutterButtonIcon(int resId) {
        ...
        if (resId == R.drawable.ic_freeme_shutter_photo
    ...
    protected boolean setFrame(int left, int top, int right, int bottom) {
        ...
        if (extendPanel != null) {
            extendPanel.setPadding(0, 0, 0, ((CameraActivity) getContext()).getCameraAppUI().getCaptureLayoutHelper().getBottomAreaHeight());
        }

        if (smallFilter != null) {
            smallFilter.setPadding(0, 0, 0, ((CameraActivity) getContext()).getCameraAppUI().getCaptureLayoutHelper().getBottomAreaHeight());
        }
    ...
    private void initialize() {
        mCenterScanText = findViewById(R.id.center_scan_text);
    }

    public void setCenterScanText(String text) {
        if (TextUtils.isEmpty(text)) {
            mCenterScanText.setVisibility(View.INVISIBLE);
            mShutterButton.setVisibility(View.VISIBLE);
        } else {
            mCenterScanText.setVisibility(View.VISIBLE);
            mCenterScanText.setText(text);
            mShutterButton.setVisibility(View.INVISIBLE);
        }
    }
}
