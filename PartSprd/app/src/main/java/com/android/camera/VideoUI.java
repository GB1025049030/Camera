...
public class VideoUI extends DreamUI implements PreviewStatusListener, SurfaceHolder.Callback, DreamInterface, SettingUIListener{
    ...
    public void showRecordingUI(boolean recording, int orientation) {
        ...
        if (recording) {
            ...
            mActivity.getCameraAppUI().setShutterPartInBottomBarShow(
                    View.VISIBLE, true);
            mActivity.getCameraAppUI().changeToRecordingUI(((VideoModule) mController).goneSnapShotInVideo());
