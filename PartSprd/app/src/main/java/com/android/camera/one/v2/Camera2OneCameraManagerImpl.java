...
public class Camera2OneCameraManagerImpl implements OneCameraManager {
     ...
     */
    @Override
    public int[] getSprdFeatureCapabilities() {
        int[] mSprdFeatureCapabilities = getCameraCharacteristics(0).get(
    ...
    @Override
    public float[] getSprdZoomRatioSection(int cameraid) {
    ...
    @Override
    public int getAvailableSensor(int cameraId) {
