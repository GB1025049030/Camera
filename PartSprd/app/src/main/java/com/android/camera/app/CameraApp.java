...
//        guard.stop("utils initialize");
        ...
        BitmapPoolManager.I.initialization(this);
        CameraCustomManager.I.init(this);
        FreemePrivacyManager.I.registerListener(getApplicationContext(), state -> {
            if (state == FreemePrivacyManager.PRIVACY_RESULT_OK && !CameraCustomManager.I.isCTATestVersion()) {
                UpdateMonitor.Builder
                        //*/ init UpdateMonitor
                        .getInstance(getApplicationContext())
                        //*/ register you Application to obsever
                        .registerApplication(CameraApp.this)
                        //*/ register you Application is Service or has EnrtyActivity ?
    ...
    public void onLowMemory() {
        super.onLowMemory();
        BitmapPoolManager.I.clearMemory();
    }
