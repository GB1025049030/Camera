...
public class Keys {
 ...
 // SPRD: Fix 597206 Adds new features 3DPhoto
     ...
     * SCOPE_GLOBAL VALUE
     */
    public static final String KEY_BACK_MODE = "pref_back_mode";
    public static final String KEY_FRONT_MODE = "pref_front_mode";
    ...
    public static final String KEY_SLOW_VIDEO_QUALITY_BACK = "pref_slow_video_quality_back_key";
    public static final String KEY_SLOW_VIDEO_QUALITY_FRONT = "pref_slow_video_quality_front_key";
    public static final String KEY_EFFECT_VIDEO_QUALITY_BACK = "pref_effect_video_quality_back_key";
    public static final String KEY_EFFECT_VIDEO_QUALITY_FRONT = "pref_effect_video_quality_front_key";
   ...
   public static final String KEY_CAMERA_PORTRAIT_OPTIMIZATION = "pref_camera_portrait_optimization_key";
