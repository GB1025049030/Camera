...
public class PictureSizeLoader {
    ...
    private List<Size> computeSizesForCamera(int cameraID, int defaultid) {
        ...
        if(cameraId < 0 || (cameraId != CameraUtil.getBackBlurCameraId() && cameraId != CameraUtil.getFrontBlurCameraId() && cameraId != 11
            ...
            && cameraId != CameraUtil.BACK_IR_CAMERA_ID && cameraId != CameraUtil.BACK_MACRO_CAMERA_ID)){
            cameraId = defaultid;
        }
