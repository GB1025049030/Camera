    ...
    public static Uri addImage(ContentResolver resolver, String title, long date,
     ...
     /* @} */
        ...
        if ((val != null) && (val == FilmstripItemData.TYPE_BURST || val == FilmstripItemData.TYPE_BURST_COVER ||
                val == FilmstripItemData.TYPE_AUDIO_PIC || val == FilmstripItemData.TYPE_AUDIO_HDR_PIC)) {// Bug 1159126 (NULL_RETURNS)
        ...
        */
        ...
        if (fileLength >= 0) {
            ...
            return addImageToMediaStore(resolver, title, date, location, orientation, fileLength,
                    path, width, height, mimeType, photoVoicePath, fileTag);
            /* @} */
        }
        return null;
    }
     ...
     /* @} */
        ...
        ContentValues values =
                getContentValuesForData(resolver, title, date, location, orientation, jpegLength, path, width,
                        height, mimeType, photoVoicePath, fileTag);
        /* @} */
        ...
        try {
             ...
             */
            if (uri == null){
                cursor = resolver.query(Images.Media.EXTERNAL_CONTENT_URI,null,ImageColumns.DATA+"='" + path +"'",null,null);
                long id = -1;
                if (cursor!=null){
                ...
                if (id !=-1){
                    uri = Uri.parse(Images.Media.EXTERNAL_CONTENT_URI + "/" + id);
