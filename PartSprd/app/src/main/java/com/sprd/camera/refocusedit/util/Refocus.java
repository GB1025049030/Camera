...
public class Refocus {
    ...
    static {
        System.loadLibrary("jni_refocus");
    }
	...
	public native int distance(byte a_puwInDisparity[],int a_dInDisparityW,int a_dInDisparityH,int a_uwInX1,int a_uwInY1, int a_uwInX2,int a_uwInY2,
			int a_dInVCM, byte a_pInOTPBytes[],int a_dInOTPSize);
//	public native int test1(byte a_puwInDisparity[],int a_dInDisparityW,int a_dInDisparityH,
//			int a_uwInX1, int a_uwInY1, int a_uwInX2, int a_uwInY2, int a_dInVCM,
//			byte a_pInOTPBytes[],int a_dInOTPSize);

   // public native int alSDE2_DistanceMeasurement(byte a_puwInDisparity[], int a_dInDisparityW, int a_dInDisparityH,int a_uwInX1, int a_uwInY1, int a_uwInX2, int a_uwInY2, int a_dInVCM, byte a_pInOTPBuf[], int a_dInOTPSize);

  //  public native int DistanceResult();
