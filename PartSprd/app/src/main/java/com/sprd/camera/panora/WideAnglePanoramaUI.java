...
//                        mPanoBg.getHeight() - mCaptureProgressBar.getHeight());
    ...
    public void onStopCapture() {
        ...
        mShutterButton.setImageResource(R.drawable.ic_freeme_shutter_photo);
    ...
    public void bindDirectorButton() {
        if(mTopPanel.isContain(R.integer.director_toggle_button_dream)){
            ((ButtonManagerDream) mActivity.getButtonManager()).initializeButton(
                    ButtonManagerDream.BUTTON_DIRECTOR_DREAM, null);
        }
    }
