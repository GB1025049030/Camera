...
# ----------------------------- FreemeUpdateself -----------------------------
#
-keep class com.freeme.updateself.** { *;}
...
# SPRD: fix bug545491 disable the animation to let the preview showed as early as possible
-keep class com.sprd.camera.plugin.AddCameraForCMCC { *; }
