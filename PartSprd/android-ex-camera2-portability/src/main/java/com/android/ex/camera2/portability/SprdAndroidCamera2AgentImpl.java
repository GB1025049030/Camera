...
import android.hardware.camera2.help.CaptureResultHelp;
...
//    private boolean mNeedAfBeforeCapture = true;
    ...
    public void monitorControlStateAutoChasingTraceRegion(CaptureResult result,
                                                     AndroidCamera2ProxyImpl camera2Proxy,
                                                          Rect activeArray){
        if (CaptureResultHelp.hasField("SPRD_AUTO_CHASING_TRACE_REGION")) {
        ...
        public void handleMessage(final Message msg) {
            ...
            try {
                switch (cameraAction) {
                    ...
                    case CameraActions.CAPTURE_COMPOSITE_PHOTO: {
                        final CaptureAvailableListener listener = (CaptureAvailableListener) msg.obj;
                        mCaptureReader.setOnImageAvailableListener(listener, /*handler*/this);
                        ...
                        CaptureRequest request = mPersistentSettings.createRequest(mCamera,
                                ...
                                mCaptureReader.getSurface());
                        requests.add(request);
                        List<CaptureRequest> compositeRequests =
                                mCameraProxy.mCameraCompositeRequest.create(mCamera, mCameraProxy.getCameraCharacteristics());
                        requests.addAll(compositeRequests);
...
//        saveBytes(data, "yuv");
    ...
    private static byte[] getNV21FromImage(Image img) {
        ...
        //*/ freeme.guobin, modify Memory Churn
        if (imageBytes == null || imageBytes.length != yLength * 3 / 2) {
