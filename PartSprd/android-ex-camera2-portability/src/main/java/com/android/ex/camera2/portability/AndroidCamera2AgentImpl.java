...
//                                    /*listener*/mCameraResultStateCallback, /*handler*/this);
    ...
    protected class AndroidCamera2ProxyImpl extends CameraAgent.CameraProxy {
        ...
        protected final CameraDeviceInfo.Characteristics mCharacteristics;
        ...
        public AndroidCamera2ProxyImpl(
            ...
            mCameraCharacteristics = properties;
        }
                            ...
                            try {
                                mDispatchThread.runJob(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        //*/ freeme.guobin, 20200902, modify continue photo sound
                                        Message message = mCameraHandler.obtainMessage(CameraActions.CAPTURE_PHOTO, mPicListener);
                                        mCameraHandler.sendMessageDelayed(message, 40);
                                        /*/
                    ...
                    takePictureRunnable = new Runnable() {
                        ...
                        public void run() {
                          ...
                          mCameraState.waitForStates(
                            ...
                            if (mLastSettings.getCompositeEnable()) {
                                mCameraHandler.obtainMessage(CameraActions.CAPTURE_COMPOSITE_PHOTO, mPicListener).sendToTarget();
                            } else if(mLastSettings.getNormalHdrModeEnable() == 1){
