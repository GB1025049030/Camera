...
//    }
    ...
    public abstract static class CameraProxy extends SprdCameraProxy {
        ...
        protected CameraCompositeRequest mCameraCompositeRequest = null;
        ...
        public void setCameraCompositeRequest(CameraCompositeRequest request) {
            mCameraCompositeRequest = request;
        }
    ...
    public interface CameraCompositeRequest {
        List<CaptureRequest> create(CameraDevice camera, CameraCharacteristics characteristics);
    }
}
