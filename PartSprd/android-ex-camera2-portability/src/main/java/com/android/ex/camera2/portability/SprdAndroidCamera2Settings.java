...
import android.hardware.camera2.help.CaptureRequestHelp;
...
public class SprdAndroidCamera2Settings extends AndroidCamera2Settings {
    ...
    public Camera2RequestSettingsSet getRequestSettings() {
        ...
        if (CaptureRequestHelp.hasField("ANDROID_SPRD_FACEATTRIBUTES_ENABLED")) {
        ...
        if (CaptureRequestHelp.hasField("CONTROL_SPRD_TOUCHINFO_REGION")) {
        ...
        try {
            if (CaptureRequestHelp.hasField("CONTROL_SPRD_AUTO_CHASING_REGION")) {
        ...
        if (CaptureRequestHelp.hasField("ANDROID_SPRD_ZOOM_RATIO")) {
        ...
        if (CaptureRequestHelp.hasField("CONTROL_SPRD_PORTRAIT_OPTIMIZATION_ENABLED")) {
        ...
        if (CaptureRequestHelp.hasField("CONTROL_SPRD_SMILE_CAPTURE")) {
