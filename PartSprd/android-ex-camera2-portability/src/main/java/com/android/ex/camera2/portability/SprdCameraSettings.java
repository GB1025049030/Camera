...
//    <integer name="camera_mode_3dnr_video">21</integer>
    ...
    protected boolean mCompositeEnable;

    public void setCompositeEnable(boolean composite) {
        mCompositeEnable = composite;
    }

    public boolean getCompositeEnable() {
        return mCompositeEnable;
    }
    //*/
}
