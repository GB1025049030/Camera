package com.bytedance.labcv.effectwork.effect.manager;

import static com.bytedance.labcv.effectwork.effect.model.EffectType.LITE_ASIA;
import static com.bytedance.labcv.effectwork.effect.model.EffectType.LITE_NOT_ASIA;
import static com.bytedance.labcv.effectwork.effect.model.EffectType.STANDARD_ASIA;
...
import com.bytedance.labcv.effectwork.effect.model.EffectButtonItem;
import com.bytedance.labcv.effectwork.effect.model.EffectType;
...
//    static String NODE_BEAUTY_LITE = "beauty_Android_lite";
    static String NODE_BEAUTY_LITE = "mask_beauty";
...
//        standardMap.put(TYPE_PALETTE_VIGNETTING     , 0.0F);
        ...
        //   {zh} 美型       {en} Beauty  
        // beauty reshape
        liteMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL, 0.35F);
...
//                break;
    ...
    private  EffectButtonItem getBeautyFaceItemsLite() {
        ...
        ArrayList<EffectButtonItem> items = new ArrayList<>();
            ...
            items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_SMOOTH, R.drawable.ic_beauty_smooth, R.string.beauty_face_smooth, new ComposerNode(beautyNode, "Smooth_ALL", getDefaultIntensity(TYPE_BEAUTY_FACE_SMOOTH, mEffectType)[0])));
            if (hasWhiten()){
                items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN, R.drawable.ic_beauty_whiten, R.string.beauty_face_whiten, new ComposerNode(beautyNode, "Foundation_ALL", getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN, mEffectType)[0])));
            }
    ...
    private  EffectButtonItem getBeautyFaceItemsStandard() {
        ...
        ArrayList<EffectButtonItem> items = new ArrayList<>();
        items.add(new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close));
        items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_SMOOTH, R.drawable.ic_beauty_smooth, R.string.beauty_face_smooth, new ComposerNode("beauty_face_tob", "smooth", getDefaultIntensity(TYPE_BEAUTY_FACE_SMOOTH, mEffectType)[0])));
        if (hasWhiten()){
            items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN, R.drawable.ic_beauty_whiten, R.string.beauty_face_whiten, new ComposerNode("beauty_face_tob", "whiten", getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN, mEffectType)[0])));
        }
        items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_SHARPEN, R.drawable.ic_beauty_sharpen, R.string.beauty_face_sharpen, new ComposerNode(beautyNode, "sharp", getDefaultIntensity(TYPE_BEAUTY_FACE_SHARPEN, mEffectType)[0])));
    ...
    private  EffectButtonItem getBeautyFaceItems() {
        ...
        switch (mEffectType) {
            ...
            case STANDARD_ASIA:
            case STANDARD_NOT_ASIA:
                return getBeautyFaceItemsStandard();
            default:
                break;
        }
        return null;
    ...
    private EffectButtonItem getBeautyReshapeItemsLite(){
        ...
        EffectButtonItem faceGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE,R.drawable.icon_face,R.string.beauty_reshape_face_group, new EffectButtonItem[]{
                ...
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL, R.drawable.ic_beauty_cheek_reshape, R.string.beauty_reshape_face_overall, new ComposerNode("reshape_live", "Face_ALL_Low", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_SMALL, R.drawable.ic_beauty_reshape_face_small, R.string.beauty_reshape_face_small, new ComposerNode("reshape_live", "Internal_Deform_Face", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_SMALL,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_CUT, R.drawable.ic_beauty_reshape_face_cut, R.string.beauty_reshape_face_cut, new ComposerNode("reshape_live", "Internal_Deform_CutFace", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_CUT,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_CHEEK, R.drawable.ic_beauty_reshape_cheek, R.string.beauty_reshape_face_cheek, new ComposerNode("reshape_live", "Internal_Deform_Zoom_Cheekbone",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_CHEEK,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_JAW, R.drawable.ic_beauty_reshape_jaw, R.string.beauty_reshape_face_jaw, new ComposerNode("reshape_live", "Internal_Deform_Zoom_Jawbone",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_JAW,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_CHIN, R.drawable.ic_beauty_reshape_chin, R.string.beauty_reshape_face_chin, new ComposerNode("reshape_live", "Internal_Deform_Chin",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_CHIN,mEffectType,true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FOREHEAD, R.drawable.ic_beauty_reshape_forehead, R.string.beauty_reshape_forehead, new ComposerNode("reshape_live", "Internal_Deform_Forehead",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FOREHEAD,mEffectType,true)[0]),true),
        ...
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_SIZE, R.drawable.ic_reshape_eye_size, R.string.beauty_reshape_eye_size, new ComposerNode("reshape_live", "BigEye", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_SIZE,mEffectType)[0])));
        ...
        EffectButtonItem noseGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE,R.drawable.icon_nose,R.string.beauty_reshape_nose_group, new EffectButtonItem[]{
                new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_SWING, R.drawable.ic_reshape_nose_swing, R.string.beauty_reshape_nose_swing,new ComposerNode("reshape_live", "Internal_Deform_Nose",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_SWING,mEffectType,true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_MOVE, R.drawable.ic_reshape_nose_move, R.string.beauty_reshape_nose_move,  new ComposerNode("reshape_live", "Internal_Deform_MovNose", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_MOVE,mEffectType,true)[0]),true)
        ...
        EffectButtonItem mouthGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH,R.drawable.icon_mouth,R.string.beauty_reshape_mouth_group, new EffectButtonItem[]{
                new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_ZOOM, R.drawable.ic_reshape_mouth_zoom, R.string.beauty_reshape_mouth_zoom, new ComposerNode("reshape_live", "Mouth_ALL", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_ZOOM,mEffectType,true)[0]),true),
...
//    }
    ...
    private  EffectButtonItem getStyleMakeup2DItems() {
        return new EffectButtonItem(
                ...
                new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear, R.string.close),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_baicha, R.string.style_makeup_baicha, new ComposerNode("style_makeup/baicha", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_xiaoxiong, R.string.style_makeup_xiaoxiong, new ComposerNode("style_makeup/meiyouxiaoxiong", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_lantong, R.string.style_makeup_bingchuan, new ComposerNode("style_makeup/bingchuan", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_qise, R.string.style_makeup_qise, new ComposerNode("style_makeup/qise", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_aidou, R.string.style_makeup_aidou, new ComposerNode("style_makeup/aidou", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_youya, R.string.style_makeup_youya, new ComposerNode("style_makeup/youya", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_cwei, R.string.style_makeup_cwei, new ComposerNode("style_makeup/cwei", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_nuannan, R.string.style_makeup_nuannan, new ComposerNode("style_makeup/nuannan", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_baixi, R.string.style_makeup_baixi, new ComposerNode("style_makeup/baixi", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_wennuan, R.string.style_makeup_wennuan, new ComposerNode("style_makeup/wennuan", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_shensui, R.string.style_makeup_shensui, new ComposerNode("style_makeup/shensui", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_tianmei, R.string.style_makeup_tianmei, new ComposerNode("style_makeup/tianmei", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_duanmei, R.string.style_makeup_duanmei, new ComposerNode("style_makeup/duanmei", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_oumei, R.string.style_makeup_oumei, new ComposerNode("style_makeup/oumei", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_zhigan, R.string.style_makeup_zhigan, new ComposerNode("style_makeup/zhigan", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_hanxi, R.string.style_makeup_hanxi, new ComposerNode("style_makeup/hanxi", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_yuanqi, R.string.style_makeup_yuanqi, new ComposerNode("style_makeup/yuanqi", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                },
                false
        );
    }
    ...
    private  EffectButtonItem getStyleMakeup3DItems() {
        return new EffectButtonItem(
                ...
                new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear, R.string.close),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_3D, R.drawable.icon_wumei, R.string.style_makeup_wumei, new ComposerNode("style_makeup/wumei", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_3D, R.drawable.icon_dazzling, R.string.style_makeup_dazzling_look, new ComposerNode("style_makeup/dazzling_look", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_3D, R.drawable.icon_scarlett, R.string.style_makeup_scarlett, new ComposerNode("style_makeup/scarlett", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA))),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_3D, R.drawable.icon_yeshengqiangwei, R.string.style_makeup_yeshengqiangwei, new ComposerNode("style_makeup/yeshengqiangwei", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)))
//                        new EffectButtonItem(TYPE_STYLE_MAKEUP, R.drawable.icon_yapi, R.string.style_makeup_yapizhuang, new ComposerNode("style_makeup/yapizhuang", new String[]{"Filter_ALL", "Makeup_ALL"},getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)))
                },
                false
        );
    ...
    private  EffectButtonItem getPaletteItems() {
        return new EffectButtonItem(
                ...
                new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_PALETTE_TEMPERATURE, R.drawable.icon_temperature, R.string.palette_temperature, new ComposerNode("palette/temperature", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_TEMPERATURE,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_TONE, R.drawable.icon_tone, R.string.palette_tone, new ComposerNode("palette/tone_v1", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_TONE,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_SATURATION, R.drawable.icon_saturation, R.string.palette_saturation, new ComposerNode("palette/saturation", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_SATURATION,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_BRIGHTNESS, R.drawable.icon_brightness, R.string.palette_brightness, new ComposerNode("palette/brightness_v1", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_BRIGHTNESS,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_CONTRAST, R.drawable.icon_contrast, R.string.palette_contrast, new ComposerNode("palette/contrast", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_CONTRAST,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_HIGHLIGHT, R.drawable.icon_highlight, R.string.palette_highlight, new ComposerNode("palette/highlight_v1", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_HIGHLIGHT,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_SHADOW, R.drawable.icon_shadow, R.string.palette_shadow, new ComposerNode("palette/shadow", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_SHADOW,null,false)[0]),false),
                        new EffectButtonItem(TYPE_PALETTE_LIGHT_SENSATION, R.drawable.icon_light_perception, R.string.palette_light_sensation, new ComposerNode("palette/light_sensation", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_LIGHT_SENSATION,null,true)[0]),true),
                        new EffectButtonItem(TYPE_PALETTE_PARTICLE, R.drawable.icon_particles, R.string.palette_particle, new ComposerNode("palette/particle", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_PARTICLE,null,false)[0]),false),
                        new EffectButtonItem(TYPE_PALETTE_FADE, R.drawable.icon_fading, R.string.palette_fade, new ComposerNode("palette/fade", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_FADE,null,false)[0]),false),
                        new EffectButtonItem(TYPE_PALETTE_VIGNETTING, R.drawable.icon_vignette, R.string.palette_vignetting, new ComposerNode("palette/vignetting_new", "Filter_intensity",getDefaultIntensity(TYPE_PALETTE_VIGNETTING,null,false)[0]),false)
                }
        );
    }
    ...
    private  String beautyNode(EffectType mEffectType) {
        ...
        return mEffectType == STANDARD_ASIA || mEffectType == EffectType.STANDARD_NOT_ASIA ? NODE_BEAUTY_STANDARD : NODE_BEAUTY_LITE;
    }

    private  String reshapeNode(EffectType mEffectType) {
        return mEffectType == STANDARD_ASIA || mEffectType == EffectType.STANDARD_NOT_ASIA ? NODE_RESHAPE_STANDARD : NODE_RESHAPE_LITE;
    }
